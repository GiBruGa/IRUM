...
async function enregistrerDansSupabase(cheminImage, resultat, modele, tempsMs, taxonomie) {
  ...
  const insRes = await fetch(`${SUPABASE_URL}/rest/v1/Incident_Reports`, {
    ...
    body: JSON.stringify({ UB_id: UB_ID_DETECTIONS, Photo: cheminStockage, Description: description, verifie_humain: false, confiance_ia: resultat.confiance, tags_ia_origine: resultat.tags }),
  });
